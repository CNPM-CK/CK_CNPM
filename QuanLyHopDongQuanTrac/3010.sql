...
END
IF DB_ID(N'QuanLyHopDongQuangTrac') IS NOT NULL
BEGIN
    ALTER DATABASE [QuanLyHopDongQuangTrac] SET SINGLE_USER WITH ROLLBACK IMMEDIATE;
    DROP DATABASE [QuanLyHopDongQuangTrac];
END
GO
