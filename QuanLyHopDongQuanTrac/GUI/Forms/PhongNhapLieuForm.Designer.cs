namespace GUI.Forms
{
    partial class DanhSachNhapLieu

    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(DanhSachNhapLieu));
            panel2 = new Panel();
            ...
            sidebar.Controls.Add(btnNenmau);
            ...
            // btnNenmau
            // 
            btnNenmau.BackColor = Color.FromArgb(10, 113, 78);
            btnNenmau.Cursor = Cursors.Hand;
            btnNenmau.FlatStyle = FlatStyle.Flat;
            btnNenmau.Font = new Font("Segoe UI", 9F, FontStyle.Bold, GraphicsUnit.Point, 0);
            btnNenmau.ForeColor = Color.White;
            btnNenmau.Image = (Image)resources.GetObject("btnNenmau.Image");
            btnNenmau.ImageAlign = ContentAlignment.MiddleLeft;
            btnNenmau.Location = new Point(0, 119);
            btnNenmau.Name = "btnNenmau";
            btnNenmau.Size = new Size(193, 61);
            btnNenmau.TabIndex = 2;
            btnNenmau.Text = "Nền mẫu";
            btnNenmau.UseVisualStyleBackColor = false;
            ...
            btnDanhsachthongso.Location = new Point(0, 61);
            btnDanhsachthongso.Name = "btnDanhsachthongso";
            btnDanhsachthongso.Size = new Size(193, 61);
            btnDanhsachthongso.TabIndex = 1;
            btnDanhsachthongso.Text = "Các thông số";
            btnDanhsachthongso.UseVisualStyleBackColor = false;
            btnDanhsachthongso.Click += button1_Click;
            // 
            // btnDanhsachnv
            // 
            ...
            Controls.Add(panel1);
            Name = "DanhSachNhapLieu";
            Text = "Phòng nhập liệu";
