...
namespace GUI.Forms
{
    public partial class DanhSachDotQuanTrac : UserControl
    {
        ...
        {
            if (btnThemdotquantrac == null || containersearch == null) return;
            ...
            Control btnParent = btnThemdotquantrac.Parent; // Thường là panel6
            if (btnParent != null && btnParent != this)
            {
                int parentWidth = btnParent.Width;
                btnThemdotquantrac.Left = parentWidth - btnWidth - MARGIN;
            }
            else
            {
                btnThemdotquantrac.Left = formWidth - btnWidth - MARGIN;
            }
