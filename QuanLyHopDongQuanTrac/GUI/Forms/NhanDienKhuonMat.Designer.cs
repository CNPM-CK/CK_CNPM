namespace GUI.Forms
{
    partial class NhanDienKhuonMat
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            lblTieuDe.Text = "ĐĂNG NHẬP BẰNG KHUÔN MẶT";
            lblTieuDe.TextAlign = ContentAlignment.MiddleCenter;
            // 
            // btnXacNhan
            // 
            btnXacNhan.BackColor = Color.FromArgb(76, 175, 80);
            ...
            btnXacNhan.Location = new Point(470, 712);
            btnXacNhan.Margin = new Padding(3, 4, 3, 4);
            btnXacNhan.Name = "btnXacNhan";
            btnXacNhan.Size = new Size(200, 56);
            btnXacNhan.TabIndex = 3;
            btnXacNhan.Text = "Đăng Nhập";
            ...
            MaximizeBox = false;
            Name = "NhanDienKhuonMat";
            StartPosition = FormStartPosition.CenterScreen;
            Text = "Đăng Nhập Khuôn Mặt";
            FormClosing += NhanDienKhuonMat_FormClosing;
            Load += NhanDienKhuonMat_Load;
