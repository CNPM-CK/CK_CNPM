...
namespace GUI.Forms
{
    public partial class TrangChu : Form
    {
        ...
        {
            // Reset button cũ về opacity 100%
            if (currentActiveButton != null)
            {
                currentActiveButton.BackColor = Color.FromArgb(255, currentActiveButton.BackColor);
            }

            // Set button mới về opacity 70%
            currentActiveButton = clickedButton;
            Color originalColor = clickedButton.BackColor;
            clickedButton.BackColor = Color.FromArgb(178, originalColor.R, originalColor.G, originalColor.B); // 178 = 70% của 255
        }
        #region Form Load
        ...
        {
            SetActiveButton(btnDanhSachKhachHang);
            panel5.Controls.Clear();
        ...
        {
            SetActiveButton(btnDanhSachHopDong);
            panel5.Controls.Clear();
        ...
        {
            SetActiveButton(btnDanhSachDotQT);
            panel5.Controls.Clear();
        ...
        {
            SetActiveButton(btnDanhSachNenMau);
            panel5.Controls.Clear();
        ...
        {
            SetActiveButton(btnDanhSachThongSo);
            panel5.Controls.Clear();
        ...
        {
            SetActiveButton(btnDanhSachNhapLieu);
            panel5.Controls.Clear();
