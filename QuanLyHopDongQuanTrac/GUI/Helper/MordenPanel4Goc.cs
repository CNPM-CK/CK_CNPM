...
{
    public class ModernPanel4Goc : Panel
    {
        ...
        public Color ActiveColor { get; set; } = Color.FromArgb(235, 248, 255);

        // màu nền gốc khi không hover / không active
        ...
        {
            IsActive = active;
            BackColorFill = active ? ActiveColor : DefaultFill;
            Invalidate();
        }
